package com.digitalgd.tog.generator.modular.restful.controller;
...
public class RestfulControllerGenerator extends AbstractCustomGenerator {
    ...
    public RestfulControllerGenerator(Map<String, Object> tableContext,TemplateParam templateParam) {
