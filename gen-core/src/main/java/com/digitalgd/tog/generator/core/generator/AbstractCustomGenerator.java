...
import com.digitalgd.tog.generator.core.engine.BeetlEngine;
...
public abstract class AbstractCustomGenerator extends Generator {
    ...
    protected TemplateParam templateParam;

    public AbstractCustomGenerator(Map<String, Object> tableContext,TemplateParam templateParam) {
