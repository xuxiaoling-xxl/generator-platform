package com.digitalgd.tog.generator.modular.restful;
...
import com.digitalgd.tog.generator.modular.restful.feign.FeignApiGenerator;
import com.digitalgd.tog.generator.modular.restful.feign.FeignProviderGenerator;
import com.digitalgd.tog.generator.modular.restful.mybatisplus.DefaultMpGenerator;
...
public class RestfulApiExecutor {
    ...
    public static void executor(ContextParam contextParam, MpParam mpContext) {
        ...
        for (TableInfo tableInfo : tableInfos) {
            ...
            //生成api接口
            FeignApiGenerator feignApiGenerator = new FeignApiGenerator(map, null);
            feignApiGenerator.initContext(contextParam);
            feignApiGenerator.doGeneration();

            //生成provider
            FeignProviderGenerator feignProviderGenerator = new FeignProviderGenerator(map, null);
